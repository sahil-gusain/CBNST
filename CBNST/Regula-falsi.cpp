...
{   int m,n,x1,x2,x3;
	...
	int i=1;
	float x=	x=((a*fun(b,x1,x2,x3))-(b*fun(a,x1,x2,x3)))/(fun(b,x1,x2,x3)-fun(a,x1,x2,x3));
	do{
		...
		x=((a*fun(b,x1,x2,x3))-(b*fun(a,x1,x2,x3)))/(fun(b,x1,x2,x3)-fun(a,x1,x2,x3));
		i++;
    }while(fabs(x-a)>=0.000001 && fabs(x-b)>=0.000001);
